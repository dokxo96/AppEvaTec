...
{
    public class FicVmRhCatDirWebDetalle : FicViewModelBase
    {
        private rh_cat_dir_web Fic_rh_cat_dir_web_Item;
        ...
        public FicVmRhCatDirWebDetalle(
        ...
        {
            get { return Fic_rh_cat_dir_web_Item; }
            set
            {
                Fic_rh_cat_dir_web_Item = value;
