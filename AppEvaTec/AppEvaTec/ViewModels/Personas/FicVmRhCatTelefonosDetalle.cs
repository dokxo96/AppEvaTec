...
{
    public class FicVmRhCatTelefonosDetalle : FicViewModelBase
    {
        private rh_cat_telefonos Fic_rh_cat_telefonos_Item;
        ...
        public FicVmRhCatTelefonosDetalle(
        ...
        {
            get { return Fic_rh_cat_telefonos_Item; }
            set
            {
                Fic_rh_cat_telefonos_Item = value;
